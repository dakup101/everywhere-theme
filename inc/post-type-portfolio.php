...
function post_type_portfolio() {
	...
	$labels = array(
		'name'                  => _x( 'Portfolio', 'Post Type General Name', 'evrwhr' ),
		'singular_name'         => _x( 'Portfolio', 'Post Type Singular Name', 'evrwhr' ),
		'menu_name'             => __( 'Portfolio', 'evrwhr' ),
		'name_admin_bar'        => __( 'Portfolio', 'evrwhr' ),
	...
	$args = array(
		'label'                 => __( 'Portfolio', 'evrwhr' ),
		'description'           => __( 'Portfolio Everywher\'a', 'evrwhr' ),
		'labels'                => $labels,
